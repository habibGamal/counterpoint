...
const Navbar = ({ toggleState }: { toggleState: boolean }) => {
    const activeTab = useAppSelector(
        (state) =>
            state.routerSlice.routeStack[
                state.routerSlice.routeStack.length - 1
            ]
    );
            ...
            /> */}
                    ...
                    <div className="rounded-xl bg-[#ffffff73] w-[250px] p-8 mx-auto text-lg font-medium">
                        <div className="flex gap-2">
                            <img
                                className="w-6  icon-indigoo"
                                src="icons/sms.svg"
                            />
                            <span>للتواصل</span>
                        </div>
                        <span className="text-[#17447F] text-[16px]">
                            youstinavictor00@gmail.com
                        </span>
                    </div>
                </nav>
            )}

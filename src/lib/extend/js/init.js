import "../css/main.css";
// import '../plugin/bootstrap-4.3.1/js/bootstrap.js';
// import "../plugin/bootstrap-4.3.1/css/bootstrap.min.css";
// console.log();
...
function checkBrowserSupported() {
    if (navigator.browserSpecs.name !== "Chrome" && navigator.browserSpecs.name !== "Safari") {
        alertify.warning(
            "Please use latest Chrome or Safari browser for best results on this site. Firefox can also work, but unfortunately we do not test on it much.",
            15
        );
    }
}

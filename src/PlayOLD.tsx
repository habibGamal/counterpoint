...
[V: LH]${index === 1 && editable ? emptyVoice.join("|") + "|]" : voice2}
    ...
    const setCurrentElementFocus = (newElement: abcjs.AbcElem | null) => {
        setCurrentElement((oldElement) => {
            if (oldElement) (oldElement.abselem.elemset[0] as SVGAElement).setAttribute("fill", "black");
            return newElement;
        });
        if (newElement) (newElement.abselem.elemset[0] as SVGAElement).setAttribute("fill", "blue");
    };
    useEffect(() => {
        load({
            editable,
    ...
    const onTextChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (note.match(/".*"/g)) note = note.replace(/".*"/g, `"${e.target.value}"`);
            ...
            <div className="ltr mx-auto mt-8 2xl:mt-0 font-sans flex flex-col gap-4 items-center justify-center min-h-[calc(100vh-100px)]">
                {editable && (
                    <>
                        <ButtonGroup>
                            ...
                            <Button onClick={() => control.addSection()} content="Add Section" />
                            <Button onClick={() => control.deleteSection()} content="Delete Section" />
                            <Button onClick={() => window.location.reload()} content="Reset All" />
                        ...
                        <div className="flex gap-8 justify-center">
                            <ButtonGroup>
                                <Button
                                    ...
                                    content={<img src={note1} className="w-6 h-8 object-contain" />}
                                />
                                <Button
                                    onClick={() => control.changeNoteLength(2)}
                                    content={<img src={note2} className="w-6 h-8 object-contain" />}
                                />
                                <Button
                                    onClick={() => control.changeNoteLength(4)}
                                    content={<img src={note4} className="w-6 h-8 object-contain" />}
                                />
                                <Button
                                    onClick={() => control.changeNoteLength(8)}
                                    content={<img src={note8} className="w-6 h-8 object-contain" />}
                                />
                                <Button
                                    onClick={() => control.changeNoteLength(16)}
                                    content={<img src={note16} className="w-6 h-8 object-contain" />}
                                />
                                <BtnSeparator />
                                <Button
                            ...
                            <ButtonGroup>
                                ...
                                <Button
                                    onClick={() => control.addAccidental("^")}
                                    content={<img src={hash} className="w-6 h-8 object-contain" />}
                                />
                                <Button
                                    onClick={() => control.addAccidental("^^")}
                ...
                <div className="flex gap-8 items-center">
                    ...
                    <ButtonGroup className="mx-auto">
                        ...
                        <Button
                            className="w-8 h-8 z-40 relative"
                            onClick={() => {

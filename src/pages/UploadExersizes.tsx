...
export default function UploadExersizes() {
    const [inputs, setInputs] = useState(data);
    const collectionRef = collection(firebase, "exams");
    const docRef = doc(collectionRef, "d1");
    const store = async () => {
    ...
    return (
        <div className="w-full">
            <PageTitle title="اضافة نماذج استرشادية" subTitle="" iconSrc="icons/clipboard-tick.svg" />
            <Container>
                <button

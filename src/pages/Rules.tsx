  ...
  return (
    <div className="w-full">
      ...
      <Container>
        ...
        />
        <Card>
          وهي المقامات الكنسية أو الجريجورية التي كانت مستخدمة في ذلك الوقت
          لبناء الألحان الغنائية وهي :F
        </Card>
        <div className="grid grid-cols-2 gap-x-8 gap-y-4">
          <Illustration
        ...
        <Card>
          هذه المقامات الأربع كانت المقامات الأصلية التي انتقاها (امبروز) أحد
          أساقفة ميلانو في القرن الرابع الميلادي تقريباً، وظلت الموسيقى الأوربية
          سواء الدينية أو الدنيوية تبنى على هذه المقامات الأربع التي عرفت
          بالمقامات الأصلية حتى القرن السادس عشر تقريبا الى أن أضاف (القس
          جلارينوس) في منتصف القرن السادس عشر الميلادي مقامين هما :
        </Card>
        <div className="grid grid-cols-2 gap-x-8 gap-y-4">
          <Illustration

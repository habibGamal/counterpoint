...
export default function Exams() {
  return (
    <div className="w-full">
      <PageTitle
        title="اختبر نفسك"
        subTitle="هذه بعض الاختبارت لتقييم ادائك"
        iconSrc="icons/edit.svg"
      />
      <Container>
        <div className="relative">
          <ul className="bg-sky-900 text-2xl py-4 px-8 my-16 rounded-lg">
            <Exam name="اختبار النوع الاول" examType={1} />
            <Exam name="اختبار النوع االثاني" examType={2} />
            <Exam name="اختبار النوع الثالث" examType={3} />
            <Exam name="اختبار النوع الرابع" examType={4} />
            <Exam name="اختبار النوع الخامس" examType={5} />
          </ul>

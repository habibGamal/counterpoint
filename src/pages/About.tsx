...
function Card({
  ...
  return (
    <motion.div
      ...
      className="custom-shadow w-[880px] my-6 p-8 rounded mx-auto"
    >
    ...
    <div className="w-full">
      ...
      <div className="my-12 text-center">
        ...
        >
          ...
          <h2 className="text-sky-900 font-medium text-3xl">فكرة البرنامج</h2>
        </motion.div>
        <motion.h3
          {...animationProps(0.05)}
        ...
        >
          البرنامج جزء من متطلبات الحصول على درجة دكتوراة في الفلسفة في التربية
          النوعية تخصص التربية الموسيقية (نظريات وتأليف)
        </motion.p>
      </div>
      <div className="my-20 2xl:my-24 text-center">
        ...
        >
          ...
          <h2 className="text-sky-900 font-medium text-3xl">تحت عنوان</h2>
        </motion.div>
        <motion.h3
          {...animationProps(0.2)}
          className="text-4xl text-sky-800 mb-4"
        >
          “برنامج إلكتروني قائم على الكونتربوينت المقيد (صوت مقابل صوت) “
        </motion.h3>
      </div>
      <div className="my-20 2xl:my-24 text-center">
        <motion.div
        ...
        >
          ...
          <h2 className="text-sky-900 font-medium text-3xl">تحت إشراف كلاً من</h2>
        </motion.div>
        <Card
          delay={0.3}
      ...
      <div className="my-20 2xl:my-24 text-center">
        ...
        >
          ...
          />
          <h2 className="text-sky-900 font-medium text-3xl">ويسعدني أن أشكر كلاً من</h2>
        </motion.div>
        <Card
          title="أ.د/ أبرار مصطفى إبراهيم علي"
          desc="أستاذ النظريات والتأليف بقسم التربية الموسيقية ووكيل شئون التعليم والطلاب – كلية التربية النوعية"

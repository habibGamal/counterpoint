    ...
    <div className="w-full">
      ...
      <Container>
        <Form onFinish={onFinish}>
          ...
          />
          <Card>
            <Form.Item label="1-	المقام المسموح فيه رفع الحساس" name="2-1">
              <Radio.Group>
            ...
            <Form.Item label="6- ينتمي هذ اللحن للنوع " name="2-6">
              <Radio.Group>
            ...
            <Form.Item label="7-	يسمي هذ المقام باسم " name="2-7">
              <Radio.Group>
          ...
          <div className="p-8 flex items-center gap-8">
            ...
            {degree !== null && <span className="text-lg font-bold border-b-4 border-sky-900">{degree}/ 44</span>}
          </div>
        </Form>
      </Container>
    </div>

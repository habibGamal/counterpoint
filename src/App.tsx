...
import ConterpointTypes from './pages/old/ConterpointTypes';
...
import Type1 from './pages/old/conterpoint_types/Type1';
import Type2 from './pages/old/conterpoint_types/Type2';
import Type3 from './pages/old/conterpoint_types/Type3';
import Type4 from './pages/old/conterpoint_types/Type4';
import Type5 from './pages/old/conterpoint_types/Type5';
import Exersizes from './pages/old/Exersizes';
import Exams from './pages/old/Exams';
